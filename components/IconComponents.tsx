...
export const ProfessionIcon = ({ profession, className }: { profession: string, className?: string }) => {
    ...
    const icons: { [key: string]: React.ReactNode } = {
        ...
        'Builder': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.472-2.472" /><path strokeLinecap="round" strokeLinejoin="round" d="m5.106 5.106 2.472 2.472m6.216 6.216L8.44 8.44m5.877 5.877-2.472-2.472M15.17 11.42 8.44 17.25" /><path strokeLinecap="round" strokeLinejoin="round" d="m17.25 8.44-5.877 5.877M14.06 14.06l-2.472 2.472" /><path strokeLinecap="round" strokeLinejoin="round" d="m11.573 8.442.063.063m-6.364 6.364.063.063" /></svg>,
        ...
        'Reporter': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12 5.25v-1.5m-6-9v1.5m0-1.5a6 6 0 016 6v1.5m-6-7.5a6 6 0 00-6 6v1.5" /></svg>,
        'Weatherman': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-3.758-3.848 5.25 5.25 0 00-9.743 1.543 4.5 4.5 0 00-1.332 6.004z" /></svg>,
        'Basketball Player': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 110-18 9 9 0 010 18z" /><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5M12 3.75c-3.14 0-6 2.56-6 5.7s2.86 5.7 6 5.7 6-2.56 6-5.7-2.86-5.7-6-5.7z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c3.14 0 6-2.56 6-5.7s-2.86-5.7-6-5.7-6 2.56-6 5.7 2.86 5.7 6 5.7z" /></svg>,
        'Soccer Player': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 110-18 9 9 0 010 18z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5L9 9.75v4.5l3 2.25 3-2.25v-4.5L12 7.5z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5l-3.75-2.25M12 7.5l3.75-2.25M3.375 9.75l3.75 2.25M20.625 9.75l-3.75 2.25M3.375 14.25l3.75-2.25M20.625 14.25l-3.75-2.25" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5l-3.75 2.25M12 16.5l3.75 2.25" /></svg>,
        'Football Player': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M6.375 9.75c-1.25 2.833.5 6.5 5.625 6.5s6.875-3.667 5.625-6.5C16.375 7.167 14.125 6 12 6s-4.375 1.167-5.625 3.75z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25v2.25M9 12h6" /></svg>,
        'Teacher': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg>,
        'Runner': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a2.25 2.25 0 110-4.5 2.25 2.25 0 010 4.5zM9.525 8.625l2.475-1.5 3.675 6.125-2.85 4.75h-3.6l-2.85-4.75 3.15-4.625zM9 18h6" /></svg>,
        'Driver': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 12a3 3 0 100-6 3 3 0 000 6z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75v4.5m0 7.5v4.5M5.636 8.636l3.182 3.182m6.364-6.364l-3.182 3.182" /></svg>,
        'Photographer': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.776 48.776 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" /><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" /></svg>,
        'DJ': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M9 18.75V15.75m0 0h6m-6 0a3.75 3.75 0 11-7.5 0V12a3.75 3.75 0 013.75-3.75h.75a3.75 3.75 0 013.75 3.75v3.75m0 0a3.75 3.75 0 107.5 0V12a3.75 3.75 0 00-3.75-3.75h-.75a3.75 3.75 0 00-3.75 3.75v3.75" /></svg>,
        'Fast Food Worker': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75C3.75 5.23122 4.98122 4 6.5 4h11c1.5188 0 2.75 1.23122 2.75 2.75V7.5H3.75V6.75Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 16.5V18.25C3.75 19.7688 4.98122 21 6.5 21h11c1.5188 0 2.75-1.23122 2.75-2.75V16.5H3.75Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 12h13.5" /></svg>,
        'Toy Seller': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.375V6.5h-1.5V3.375c0-.621.504-1.125 1.125-1.125h.375c.621 0 1.125.504 1.125 1.125z" /><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6.5h-9a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25zM12 18.75V8.75" /></svg>,
        'Pilot': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" /></svg>,
        'Postman': <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={finalClassName}><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>,
    };
