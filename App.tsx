        ...
        <div className={`min-h-screen font-sans text-slate-800 dark:text-slate-200`}>
            ...
            <main className="container mx-auto p-4 md:p-8">
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="relative w-full max-w-2xl bg-slate-200 dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden aspect-video">
                            <video
                                ...
                                playsInline
                                muted
                                className={`w-full h-full object-cover transition-opacity duration-300 ${generatedImage ? 'opacity-0' : 'opacity-100'}`}
                            />
                            {generatedImage && (
                                <>
                                    <img src={`data:image/jpeg;base64,${generatedImage}`} alt="Generated professional" className="absolute inset-0 w-full h-full object-cover animate-fade-in" />
                                </>
                            )}
                             {cameraError && !generatedImage && (
                        ...
                        {generatedImage && (
                            <div className="flex mt-6 justify-center animate-fade-in">
                                <a
                    ...
                    <div className="w-full lg:w-1/2">
                         <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-800 dark:text-white">{generatedImage ? t('heresYourFuture') : t('chooseProfession')}</h2>
